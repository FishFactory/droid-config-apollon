...
%define device apollon
%define vendor xiaomi

%define vendor_pretty Xiaomi
%define device_pretty Mi 10T
...
%include patterns/patterns-sailfish-device-adaptation-apollon.inc
%include patterns/patterns-sailfish-device-configuration-apollon.inc
